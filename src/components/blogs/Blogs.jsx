  ...
  const allBlog = [
    {
      ...
      excerpt:
        "Discover proven strategies to connect with the right study partner and boost your learning journey.",
      image:
    ...
    },
    {
      ...
      link: "/blog/productivity-dashboard",
    },
    {
      id: 3,
      ...
      link: "/blog/balancing-study-sessions",
    },
  ];
    ...
    <section className="py-16">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-base-content/70 mb-12">
          Stay updated with study tips, platform updates, and success stories
          from our community.
        </p>
